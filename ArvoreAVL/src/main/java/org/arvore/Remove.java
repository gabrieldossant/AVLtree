...
public class Remove extends Rotate {
    Node deletarNo(Node raiz, int chave) {
        // Caso a arvore esteja vazia retorne null.
        if (raiz == null) {
            return raiz;
        }
        ...
        }//Se a chave é igual a chave do nó atual, este é o nó a ser removido.
        else {
            //Caso 1: nó com apenas um filho ou nenhum filho.
            if ((raiz.esquerda == null) || (raiz.direita == null)) {
                Node temp = null;
                // Atribui o filho não nulo a temp (ou null se não houver filhos)
                ...
                // Caso 2: nó com dois filhos, encontre o sucessor (menor valor na subárvore direita)raiz = temp;
                Node temp = Math.min(ValueNode(raiz.direita));
